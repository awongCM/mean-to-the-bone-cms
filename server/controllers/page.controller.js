...
exports.getPage = async function(req, res, next) {
  ...
  try {
    ...
    return res.status(200).json({data: page, message: "Successfully fetched Page"});
...
exports.createPage = async function(req, res, next) {
  ...
  try {
    ...
    return res.status(200).json({data: createdPage, message: "Successfully fetched Page"});
  } catch (error) {
    return res.status(400).json({message: e.message});
  }
}
...
exports.updatePage = async function(req, res, next) {
  ...
  try {
    ...
    return res.status(200).json({data: updatedPage, message: "Successfully Updated Page"});
  } catch (error) {
    return res.status(400).json({message: e.message});
  }
