...
exports.getHeader = async function(req, res, next) {
  ...
  try {
    ...
    return res.status(200).json({data: header, message: "Successfully fetched header"});
...
exports.createHeader = async function(req, res, next) {
  ...
  try {
    ...
    return res.status(200).json({data: createdHeader, message: "Successfully fetched Header"});
  } catch (error) {
    return res.status(400).json({message: e.message});
  }
}
...
exports.updateHeader = async function(req, res, next) {
  ...
  try {
    ...
    return res.status(200).json({data: updatedHeader, message: "Successfully Updated Header"});
  } catch (error) {
    return res.status(400).json({message: e.message});
  }
