...
exports.getFooter = async function(req, res, next) {
  ...
  try {
    ...
    return res.status(200).json({data: footer, message: "Successfully fetched Footer"});
...
exports.createFooter = async function(req, res, next) {
  ...
  try {
    ...
    return res.status(200).json({data: createdFooter, message: "Successfully fetched Footer"});
  } catch (error) {
    return res.status(400).json({message: e.message});
  }
}
...
exports.updateFooter = async function(req, res, next) {
  ...
  try {
    ...
    return res.status(200).json({data: updatedFooter, message: "Successfully Updated Footer"});
  } catch (error) {
    return res.status(400).json({message: e.message});
  }
